    ...
    function Sortable(element, options) {
        ...
        _this.onDragStop = function (e) {
            ...
            if (isPlaceHolderPresent) {
                ...
                var prevIndx = _this === dropInst && (prevIdx - curIdx_1) > 1 ? prevIdx - 1 : prevIdx;
                var args = {
                    previousIndex: prevIndx, currentIndex: curIdx_1, target: e.target, droppedElement: _this.target,
